<template>
  ...
  <Window
      ...
      :rightButtonDisabled="!hasSelectedFilters"
...
import { Text, Button } from '~/vue-library';
...
import { clearAllFilters, filters } from '@/composables/useMapFilters.js';
