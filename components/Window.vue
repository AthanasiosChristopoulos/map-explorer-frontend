    <template>
        <transition name="window-animation" >
            <div 
                :class="isMobile() ? '' : 'window-container'" 
                v-if="isExpanded || isMobile()"  
                role="dialog"
                aria-modal="true"
            >
                <transition :name="isMobile() ? 'mobile' : 'window-animation-inner'">
                        <div 
                            class="window"
                            ref="popupRef" 
                        ...
                        >
                            <Button 
                                ...
                                style="margin-bottom: 1rem; scale: 0.9;"
                            />
